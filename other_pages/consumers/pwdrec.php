...
if (isset($_POST['pwdreset'])) {
    ...
    $statement = $pdo->prepare("SELECT * FROM cregister WHERE uname=:usname");
    ...
    if ($statement->rowCount() > 0) {
        $stupd = $pdo->prepare("UPDATE cregister SET password=:cpwd WHERE uname=:usname");
...
<head>
    ...
    <title>Consumer's password recovery - Foodstuff</title>
</head>
                ...
                <div class="card bg-dark px-3 py-3">
                    ...
                    <div class="card-body">
                        <form action=" " method="POST" id="loginform">
                            ...
                            <p class="text-center text-light mt-3"><a href="./consumer-log.php" class="text-decoration-none">Back to login</a></p>
                        </form>
