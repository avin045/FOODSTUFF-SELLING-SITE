...
<body style="background-color: silver;">
    ...
    <ul class="nav justify-content-center p-3 bg-dark subnav nav-pills">
        ...
        <li class="nav-item nedpad">
            <a class="nav-link active" href="../consumers/viewp_c_veg.php">Vegetables</a>
        </li>
        <li class="nav-item">
                ...
                <?php foreach ($products as $i => $product) { ?>
                    <div class="col mb-4">
                        <div class="card bg-dark text-light">
                            <img src="<?php echo "../" . $product['pimage'] ?>" class="card-img-top img-responsive" alt="product image" height="200px">
                            <div class="card-body pb-2">
                                ...
                                <p class="card-text p-0 m-0 text-danger">
                                    Price/Kg<br><?php echo $product['pprice'] ?>
                                    <?php
                                ...
                                <div class="text-center p-0 m-0 ">
                                    <!-- <form action="./reservedplace.php?" method="GET"> -->
